    ...
    public partial class KnowledgeMapImageEntity : KnowledgeMapEntityBase
    {
				...
				if (this._imageMemoryStream == null)
				{
					...
					else
					{
						...
						if (bmpsource != null)
						{
							...
							throw new InvalidCastException("Image entity source stream is not accessable. The source is not a BitmapImage/Uri.");
					}
				}
		...
		public override void Release()
		{
			lock (this._locker)
			{
				...
				catch (ObjectDisposedException obDEx)
				{
					SiliconStudio.DebugManagers.DebugReporter.Report(
						SiliconStudio.DebugManagers.MessageType.Error,
						"EjpControls KnowledgeMap Image Entity",
						"Failed to dispose image memory Stream." +
