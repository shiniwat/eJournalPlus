    ...
    public partial class KnowledgeMap : System.Windows.Controls.UserControl
    {
        ...
        private void OnMapCanvasPreviewMouseUp(object sender, MouseEventArgs e)
        {
            ...
            switch (this._inputState)
            {
                ...
                case KnowledgeMapInputState.Note:
                    ...
                    this.AddTextEntity(Properties.Resources.Str_NewKMSelfNodeTitle, "", new XpsDocumentReference(), "",
                ...
                case KnowledgeMapInputState.Label:
                    ...
                    tb.Text = Properties.Resources.Str_NewKMLabelDefaultContent;
        ...
        private void OnMapCanvasDrop(object sender, DragEventArgs e)
        {
            ...
            if (isReferencedImage)
            {
                ...
                {
                    MessageBox.Show(Properties.Resources.ERR_AddKMEntityFailed_Locked,
                        Properties.Resources.Str_MsgTitle_KMLocked, MessageBoxButton.OK, MessageBoxImage.Stop);
                    return;
                }
                ...
                this.AddImageEntity(Properties.Resources.Str_NewKMIMGEntityTitle, dropImage.IBrush.ImageSource, new SolidColorBrush(newColor),
            ...
            else if (isReferencedText)
            {
                ...
                this.AddTextEntity(Properties.Resources.Str_NewKMTextEntityTitle, q.UnicodeString, q.Reference, q.CommentString,
            ...
            double width, double height, double x, double y)
        {
            ...
            catch (Exception)
            {
                ...
                throw new ApplicationException(Properties.Resources.EX_SetGuideFailed);
            }
        }
        ...
        public void ClearKnowledgeMapGuide()
        {
            ...
            {
                throw new ApplicationException(Properties.Resources.EX_DelGuideFailed);
            }
        }
                ...
                this._knowledgeMapGuideDataStream.CanRead == false)
            {
                ...
                else
                {
                    ...
                    if (bmpsource != null)
                    {
                        ...
                        throw new InvalidCastException(Properties.Resources.EX_LoadGuideFailed);
                }
            }
        ...
        public void SetNormalMode()
        {
            ...
            foreach (KnowledgeMapComment kmC in this._commentsList)
            {
                ...
                this.AddTextEntity(Properties.Resources.Str_ConvertedCommentNodeTitle, sb.ToString(),
                    new XpsDocumentReference(), "",
                        KnowledgeMapEntityType.OriginalToMap,
                        Brushes.Black,
        ...
        private void OnCMSCanvasInputUp(Point position)
        {
            if (this._isDraggingComment)
            {
                ...
                this._currentlyDraggedComment.IsDragging = false;
                //...
                //this._currentlyDraggedComment.PushPinCoordinates = position;
            }
            else
            {
